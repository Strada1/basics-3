...
function createTask () {
  ...
  const templateTaskElement = templateTask.querySelector('div') //находим нужный элемент во фрагменте
  ...
  let element = templateTaskElement.cloneNode(true) //клонируем элемент с изменениями
