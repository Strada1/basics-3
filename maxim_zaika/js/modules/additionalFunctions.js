...
import {STATUSES, PRIORITY, todoList, exampleTask, sectionHigh, sectionLow} from "./initialData.js";
...
function getText(fieldAdding) {
    const textFromTask = fieldAdding.value[0].toUpperCase() + fieldAdding.value.slice(1);
    return textFromTask;
}
...
export {clear, createTask, showTask, getText, getPrority, addInTodoList, clearFieldAdding, add, deleteFromTodoList};